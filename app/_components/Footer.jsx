        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              Revolutionizing the hiring process with AI-powered voice interviews that deliver smarter, faster, and fairer recruitment solutions.
            </p>
          ...
          <div className="space-y-6">
            ...
            <nav className="space-y-3">
              {['AI Interviews', 'Voice Analysis', 'Performance Insights', 'Integration', 'Support'].map((link) => (
